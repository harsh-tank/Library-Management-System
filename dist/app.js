...
app.listen(process.env.PORT, function () {
    ...
    model_config_1.sequelize.authenticate().then(function () { return __awaiter(void 0, void 0, void 0, function () {
        var error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, model_config_1.sequelize.sync({ force: true })];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
